...
void En_Res()
{
  ...
  if(DoRescale)   tmg->SetTitle("HGCal Energy resolution (After rescaling + reshifting) | Pion 200 GeV;Compartment number; Energy Resolution ( #frac{#sigma}{#mu} )");
  else tmg->SetTitle("HGCal Energy resolution | Pion 200 GeV;Compartment number; Energy Resolution ( #frac{#sigma}{#mu} )");
