  ...
  for(int i=0;i<6;i++)
    {
      ...
      TH1F* ABS = tf1->Get("Sum_Abs_"+HH[i]);
      TH1F* LIK = tf1->Get("Sum_Abs_Leak_"+HH[i]);
      TH1F* WGT = tf1->Get("RecEn_"+HH[i]);
      TH1F* DAT = tf2->Get("RecEn_"+HH[i]);
      ...
      tc->SaveAs("PNG/RecoEn/Pion_"+energy+"_RecEn_"+HH[i]+"_13_08_19.png");
      tc->SaveAs("PDF/RecoEn/Pion_"+energy+"_RecEn_"+HH[i]+"_13_08_19.pdf");
      delete tc;
    }
