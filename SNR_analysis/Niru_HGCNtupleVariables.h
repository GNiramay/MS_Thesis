...
#ifndef Niru_HGCNtupleVariables_h
#define Niru_HGCNtupleVariables_h
...
class Niru_HGCNtupleVariables {
public :

   Niru_HGCNtupleVariables(TTree * /*tree*/ =0) : fChain(0) { }
  ~Niru_HGCNtupleVariables() { }
  ...
  // std::map<std::pair<int, int>, float> my_calib_map;
   ...
   TBranch        *b_rechit_time;  // Niramay. Commented coz. there is no branch with this name!
...
#ifdef Niru_HGCNtupleVariables_cxx

void Niru_HGCNtupleVariables::Init(TTree *tree, TTree *tree2)
/* void Niru_HGCNtupleVariables::Init(TTree *tree) */
{
   ...
   /* fChain->SetBranchAddress("rechit_time", &rechit_time, &b_rechit_time); /\* Niramay. Commented out coz there is no n=branch with this name *\/ */
...
Bool_t Niru_HGCNtupleVariables::Notify()
{
...
#endif // #ifdef Niru_HGCNtupleVariables_cxx
